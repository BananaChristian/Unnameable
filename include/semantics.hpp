...
public:
  ...
  ResolvedType resolveFuncPtrType(Node *fnMod, Node *type_mod,
  ...
  void collectDimensions(TypeModifier *modifier,
...
private:
  ...
  ResolvedType makeFnPtrType(const ResolvedType &base,
