...
impl AstPrinter {
    ...
    pub fn fmt_type(&mut self, ty: &Type) {
        match &ty.kind {
            ...
            TypeKind::Str => self.write_line("Type(str)"),
            TypeKind::Char8 => self.write_line("Type(char8"),
            TypeKind::Char16 => self.write_line("Type(char16"),
            TypeKind::Char32 => self.write_line("Type(char32)"),
